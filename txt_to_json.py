...
classes = ['Bud', 'Early', 'Full', 'Late']# 这里改一下

parser = argparse.ArgumentParser()
parser.add_argument('--image_path', default='images/val',type=str, help="path of images")# 图片路径改一下
parser.add_argument('--label_path', default='labels/val',type=str, help="path of labels .txt")#图片标签路径改一下
